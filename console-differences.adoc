...
NetAppは、統合ストレージ管理プラットフォームを実行するための2つの方法を提供しています：NetApp ConsoleとNetApp Consoleローカル展開。両者は共通の基盤を共有していますが、アーキテクチャ、接続性、機能範囲、および運用モデルにおいて異なります。NetApp Consoleは、お客様の環境にデプロイされたConsoleエージェントを使用してストレージシステムを管理します。NetApp Consoleローカル展開は、エージェントレスの仮想マシンです。NetApp Consoleローカル展開は、ONTAPクラスターと直接通信し、NetApp Consoleでは利用できないエンタープライズフリート管理機能を提供します。
...
https://docs.netapp.com/us-en/console-setup-admin/concept-modes.html["NetApp Console の導入モードについて"^]。
...
link:https://docs.netapp.com/us-en/concept-netapp-console-local.html["NetApp Console のローカルデプロイメントについて説明します^。"]
